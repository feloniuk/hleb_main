...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nazvanie)) {
        ...
        // Перевірка, чи існує інший продукт з такою назвою
        ...
        if ($count > 0) {
            ...
            if (empty($error)) {
                ...
                $updateQuery = "UPDATE product SET nazvanie = ?, ves = ?, srok = ?, stoimost = ?, zena = ?, image = ? WHERE id = ?";
                $stmt = mysqli_prepare($connection, $updateQuery);
                mysqli_stmt_bind_param($stmt, "sdiddsi", $nazvanie, $ves, $srok, $stoimost, $zena, $imagePath, $productId);
                
                if (mysqli_stmt_execute($stmt)) {
                    $success = 'Продукт успішно оновлено';
                    
                    // Запис в журнал
                    logAction($connection, 'Оновлення продукту', 'Оновлено продукт: ' . $nazvanie);
                    ...
                    $error = 'Помилка при оновленні продукту: ' . mysqli_error($connection);
                }
                ...
                <div class="col-md-9">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="category" name="category">
                                ...
                                <option value="1" <?php echo (isset($product['category']) && $product['category'] == 1) ? 'selected' : ''; ?>>Хліб</option>
                                <option value="2" <?php echo (isset($product['category']) && $product['category'] == 2) ? 'selected' : ''; ?>>Булочки</option>
                                <option value="3" <?php echo (isset($product['category']) && $product['category'] == 3) ? 'selected' : ''; ?>>Пиріжки</option>
                                <option value="4" <?php echo (isset($product['category']) && $product['category'] == 4) ? 'selected' : ''; ?>>Кондитерські вироби</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="form-control" id="margin">
                                    <?php 
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div id="image-preview" class="text-center">
                                    ...
                                    ?>
                                    <img src="<?php echo $imagePath; ?>" alt="Зображення продукту" class="img-fluid" style="max-height: 200px;">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="available" name="available" value="1" <?php echo (isset($product['available']) && $product['available'] == 1) ? 'checked' : ''; ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="featured" name="featured" value="1" <?php echo (isset($product['featured']) && $product['featured'] == 1) ? 'checked' : ''; ?>>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="new" name="new" value="1" <?php echo (isset($product['new']) && $product['new'] == 1) ? 'checked' : ''; ?>>
